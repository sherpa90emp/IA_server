...
from stream.StreamGenerator import StreamGenerator
from stream.ToolStreamGenerator import ToolStreamGenerator

class JarvisServerIDE(StreamGenerator, ToolStreamGenerator):
