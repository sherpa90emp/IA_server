...
├── model_select_embedding.py      # Selezione modello embedding (opzionale)
...
├── tools/
│   └── meteo.py                   # Tool meteo (stub incompleto)
...
[FastAPI — JarvisServerIDE]
    ...
    POST /v1/embeddings         → vettori embedding (se modello caricato)
        ↓
...
- I modelli embedding vengono identificati dalla presenza di `emb` nel nome della cartella
